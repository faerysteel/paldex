#![allow(dead_code)]
// Pre-existing in upstream repak (ext.rs's ReadExt::read_array trips a
// standard-library name-collision lint on newer Rust); not something this
// vendored patch introduced or wants to hand-edit further.
